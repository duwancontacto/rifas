...
export const getRafflesPurchase = (pagination: number) => {
  return Api({
...
export const createCauseGallery = (image: any, causeId: string) => {
  const formData = new FormData();
...
export const createPrizeGallery = (image: any, prizeId: string) => {
  const formData = new FormData();
...
export const deleteImageGallery = (id: number) => {
  return Api({
...
export const deleteImageGalleryRaffle = (id: number) => {
  return Api({
